...
model, optimizer, learning_rate, epochs = utils.load_checkpoint(r'./model/G_1191.pth', net_g_ms, None)
        ...
        with gr.Tabs():
            with gr.TabItem("vits"):
                with gr.Row():
                    ...
                    btn.click(vits, inputs=[input_text, lang, sid, ns, nsw, ls], outputs=[o1, o2, o3], api_name="addition")
